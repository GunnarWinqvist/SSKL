...
#
# Notes:
# * This file is based on the http://pear.php.net/go-pear but modified to work during the transition of PEAR to GitHub.
...
$bootstrap_files = array(
    ...
    'Console/Getopt.php'   => 'http://svn.php.net/viewvc/pear/packages/Console_Getopt/trunk/Console/Getopt.php?view=co'
    );
...
function download_url_for_https($url, $destfile = null)
{
...
function download_url($url, $destfile = null, $proxy = null)
{
    ...
    if ($tmp['scheme'] == 'https') {
      return download_url_for_https($url, $destfile);
    }
